...
import { BsShieldCheck, BsCalendarCheck, BsCoin } from "react-icons/bs";
    ...
    <div className={styles.advice}>
      ...
      <section className={styles.transactionCard}>
        ...
        <div className={styles.transactionBottom}>
          ...
          <div className={styles.riskBlock}>
            ...
            <span className={styles.riskPill}>📊 {transaction.riskLevel}</span>
          </div>
        </div>
      ...
      <section className={styles.aiAdviceCard}>
        ...
        <p>
          ...
          <strong>RM {transaction.projectedSpent.toFixed(2)}</strong>, nearly
          reaching your monthly budget of{" "}
          <strong>RM {transaction.budgetLimit.toFixed(0)}</strong>. Making one
          more similar purchase may affect your{" "}
          <strong>RM {transaction.savingsGoal.toFixed(0)}</strong> savings goal.
        </p>
      </section>
